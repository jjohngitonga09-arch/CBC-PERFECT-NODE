// KpiCard.jsx - dark-mode-aware version
// Drop-in replacement; same props as before + optional `icon` prop
...
export default function KpiCard({ label, value, sub, color = 'blue', icon }) {
 ...
 {/* Icon box - uses solid accent color so it's always visible */}
 <div
 style={{
 width: 40,
 height: 40,
 ...
 {/* Sub text */}
 {sub && (
 <p style={{ margin: 0, fontSize: '.72rem', color: c.icon, fontWeight: 600 }}>
 {sub}
 </p>
 )}
 </div>
