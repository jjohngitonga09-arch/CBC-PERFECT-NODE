...
const card = { background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "16px", padding: "24px" };
...
export default function LinkParent() {
 ...
 return (
 <div style={card}>
 <h2 style={{ color: "var(--text)", fontWeight: 700, fontSize: "1.1rem", margin: "0 0 6px" }}>
 Link My Parent
 </h2>
 <p style={{ color: "var(--sub)", fontSize: ".85rem", margin: "0 0 20px" }}>
 ...
 {linked.email && <p style={{ color: "var(--sub)", fontSize: ".8rem", margin: 0 }}>{linked.email}</p>}
 {linked.phone && <p style={{ color: "var(--sub)", fontSize: ".8rem", margin: 0 }}>{linked.phone}</p>}
 </div>
 ...
 style={{ flex: 1, minWidth: "200px", background: "var(--bg)", border: "1px solid var(--border)", color: "var(--text)", borderRadius: "10px", padding: "10px 14px", fontSize: ".875rem", outline: "none" }}
 />
 <button onClick={link} disabled={saving}
 style={{ background: saving ? "var(--surface-hover)" : "linear-gradient(135deg,#6366f1,#4f46e5)", color: saving ? "var(--sub)" : "#fff", border: "none", borderRadius: "10px", padding: "10px 20px", fontWeight: 700, fontSize: ".875rem", cursor: saving ? "default" : "pointer" }}>
