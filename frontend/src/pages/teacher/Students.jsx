...
const card = { background: "#161b27", border: "1px solid #1f2937", borderRadius: "14px", padding: "14px 18px", marginBottom: "8px" };
const SC = {
...
export default function TeacherStudents() {
 ...
 <h1 style={{ fontSize: "1.7rem", fontWeight: 800, color: "#f9fafb", margin: "0 0 4px" }}>Students</h1>
 <p style={{ fontSize: ".875rem", color: "#6b7280", margin: 0 }}>{students.length} total {active} active {online} online now</p>
 </div>

 <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search by name or email..."
 style={{ width: "100%", background: "#0f1421", border: "1px solid #1f2937", color: "#f9fafb", borderRadius: "10px", padding: "10px 14px", fontSize: ".875rem", outline: "none", marginBottom: "16px", boxSizing: "border-box" }} />
 ...
 {isOnline && <span style={{ position: "absolute", bottom: 1, right: 1, width: 10, height: 10, borderRadius: "50%", background: "#34d399", border: "2px solid #161b27" }} />}
 </div>
 <div>
 <p style={{ fontWeight: 700, color: "#f9fafb", margin: "0 0 2px" }}>{s.name}</p>
