...
function MathNotes() {
  return (
    <div style={{ color: 'var(--text)', lineHeight: 1.6 }}>
      ...
      <Section title="MODULE 1: ADVANCED NUMERACY, PLACE VALUE, AND BASE-10 MATRIX SYSTEMS">
        <SubSection title="1.1 Architectural Architecture of Base-10 Structures">
          <p>The numerical system utilized globally is founded upon an inductive decimal framework known as the Base-10 system. In this architecture, the position of any individual digit dictates its specific scalar magnitude. Each step to the left across a standard positional grid increases the absolute value of a digit by an exact scale factor of ten (10°). Conversely, moving one step to the right decreases the magnitude by a factor of ten (10?×).</p>
        </SubSection>
      </Section>
    </div>
  );
 ...
 - 0 Dependent Clauses    - Joined by FANBOYS      - 1+ Dep. Clause
        ...
        <SubSection title="2.12 Module 2 Evaluation Assessment (Comprehensive Questions & Answers)">
          <div style={{ background: '#f0fdf4', padding: '14px', borderRadius: '8px', borderLeft: '4px solid #16a34a', margin: '12px 0' }}>
            ...
            <p>"on a rainy monday afternoon dr amina omari drove her silver car through the streets of kisumu she needed to reach the imperial bank before it closed at 4:00 pm why was she in such a hurry she had to mail an important legal document to nairobi"</p>
            <p><strong>Answer:</strong> "On a rainy Monday afternoon, Dr. Amina Omari drove her silver car through the streets of Kisumu. She needed to reach the Imperial Bank before it closed at 4:00 p.m. Why was she in such a hurry? She had to mail an important legal document to Nairobi."</p>
          </div>
          <div style={{ background: '#f0fdf4', padding: '14px', borderRadius: '8px', borderLeft: '4px solid #16a34a', margin: '12px 0' }}>
 ...
 [ Mnyambuliko wa Vinyume ]                                  [ Kazi za Vihusishi ]
  × Funga --&gt; Fungua (-ua) × KWA: Kifaa, Njia, au Mahali × Anika --&gt; Anua (-ua) × NA: Kuunganisha au Mtendaji × Bandika --&gt; Bandua (-ua) × KWA AJILI YA: Lengo, Faida, au Sababu`}</pre>
      ...
      <Section title="MTIHANI KAMILI WA MARUDIO WA LUGHA YA KISWAHILI">
        <p><strong>KIDATO/NGAZI: Darasa la 5 / Shule ya Msingi (Junior Primary) | MUDA: Saa 2:00 | ALAMA ZOTE: ALAMA 100</strong></p>
