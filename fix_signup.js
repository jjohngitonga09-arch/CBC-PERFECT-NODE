const fs = require('fs');
const file = "C:\\Users\\pc\\Downloads\\eduapp\\frontend\\src\\pages\\auth\\Signup.jsx";
    ...
    <div style={{ minHeight:"100vh", background:"linear-gradient(135deg,#1b5e20,#2d6a4f,#1a237e)", display:"flex", alignItems:"center", justifyContent:"center", padding:16, fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <div className="card">
        ...
        {step === 1 && (<>
          ...
          {error && <div style={{background:"#fef2f2",border:"1px solid #fca5a5",borderRadius:8,padding:"10px 14px",fontSize:".82rem",color:"#dc2626",marginBottom:16}}>⚠️ {error}</div>}
...
console.log('Signup.jsx updated successfully!');